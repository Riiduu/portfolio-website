...
const ContactComponent = () => {
    return (
        <div
            className=" flex flex-col md:flex-row justify-center h-96 mt-28 md:justify-between relative items-center mx-4 md:mx-4 lg:mx-8 xl:mx-0 md:space-x-10">
            <div>
                <h1 className="text-6xl text-white text-center md:text-left">Got a project in <br/><span
                    className="text-[var(--color-3)] font-medium ">mind?</span></h1>
