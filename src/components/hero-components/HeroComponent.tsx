...
const HeroComponent = (props: any) => {
    ...
    return (
        <div className="h-96 my-60 flex flex-row justify-center md:justify-between relative flex-wrap mx-4 md:mx-0">
            ...
            <div className="flex flex-row mb-40 my-auto z-10 overflow-visible">
                ...
                <div className="">
                    ...
                    <div className="mt-8 space-x-5 flex flex-row justify-center md:justify-start">
                        {/* Hire me button */}
                        <button className="text-white bg-[var(--color-3)] py-2 px-10 rounded-3xl" onClick={routeToContact}>Hire me</button>
                        {/* Download CV button */}
                        <button onClick={routeToCV} className="text-white bg-[#393E46] py-2 px-10 rounded-3xl flex flex-row justify-center">View CV <span
            ...
            {/* image container*/}
            <div className="z-0 absolute w-full md:w-auto md:-translate-x-0 md:right-0 top-1/2 transform -translate-y-1/2 left-1/2 -translate-x-1/2">
