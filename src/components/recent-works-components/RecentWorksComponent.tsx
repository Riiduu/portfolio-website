...
const RecentWorksComponent = () => {
    ...
    return (
        <div className="max-w-screen-xl h-full flex flex-col justify-center md:justify-between mx-auto py-72 text-white">

            <div className="mt-[-100px] flex flex-col justify-center text-center md:text-left mx-4 md:mx-4 lg:mx-8 xl:mx-0">
